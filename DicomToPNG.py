...
from dicom_to_png import dicom_to_png_dcmtk, dicom_to_png_imagemagick, dicom_to_png_matlab
...
def dicom_path_replace(dicom_path, dicom_dir, dicom_ext):
    """Replaces a / in the path of dicom_path with a \
    ...
    Returns:
        The same path as dicom_path but with / replaced by
        \.
    """
...
def main(dicom_dir, dicom_list_json_path, png_dir, dcmtk, imagemagick, matlab, dicom_types, dicom_ext):
    ...
    NOTE: When using Matlab, must be run from   dicom_to_png
    ...
    Arguments:
        ...
        matlab(bool): True to use matlab to convert DICOMs to PNGs.
    """
...
if __name__ == '__main__':
    ...
    # C:/Users/brian/Documents/Fall 2023/CMPSC 445/INbreast Release 1.0/INbreast Release 1.0/AllDICOMs
    # C:/Users/brian/Documents/Fall 2023/CMPSC 445/INbreast Release 1.0/INbreast Release 1.0/AllPNGs